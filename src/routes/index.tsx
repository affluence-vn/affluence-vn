    ...
    <section className="relative overflow-hidden bg-white pt-20 pb-24 md:pt-28 md:pb-32">
      ...
      <div ref={blobsRef} className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          data-dir="1"
          data-phase="4"
          className="absolute -bottom-40 left-1/3 will-change-transform"
        >
          <div
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <h1 className="text-[42px] font-extrabold leading-[1.05] tracking-tight md:text-[64px]">
          Chúng tôi kết nối <span className="text-gradient-brand">giáo dục</span> với{" "}
  ...
  return (
    <section id="su-menh" className="py-24 md:py-28">
      <div className="mx-auto grid max-w-6xl gap-14 px-6 md:grid-cols-2 md:items-center">
        <div>
          <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-primary">Sứ mệnh</p>
          ...
          <p className="mt-6 text-[16px] leading-[1.8] text-ink-soft">
            Chúng tôi tin rằng giáo dục là ngành xứng đáng có công cụ marketing tốt nhất — không phải quảng cáo tràn
            lan, không phải lead ảo. Affluence xây dựng cầu nối minh bạch giữa trường học và mạng lưới publisher, để mỗi
            đồng ngân sách đều tạo ra một học viên thật.
          </p>
          <p className="mt-4 text-[16px] leading-[1.8] text-ink-soft">
            Từ trung tâm ngoại ngữ nhỏ đến hệ thống giáo dục quy mô quốc tế lớn, Affluence đồng hành cùng bạn trên mọi
            ...
            <div className="flex w-full max-w-xl items-center justify-between gap-3 md:gap-4">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="grid h-14 w-14 place-items-center rounded-2xl bg-white shadow-lift ring-1 ring-border">
                  <img src={logoMark} alt="Affluence" width={32} height={32} className="h-8 w-8 object-contain" />
                </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div
                  className="grid h-14 w-14 place-items-center rounded-2xl shadow-lift"
...
function WhatWeDo() {
  const schoolFeatures = [
    ...
    },
    {
      ...
      text: "Mỗi đăng ký đều được xác minh trước. Bạn trả hoa hồng sau khi có người thật đăng ký — không cần thanh toán trước.",
    },
  ];
    ...
    <section id="hoat-dong" className="bg-page py-24 md:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-primary">Cách hoạt động</p>
          <h2 className="text-[34px] font-bold leading-[1.15] tracking-tight md:text-[42px]">Hai bên, cùng có lợi.</h2>
        </div>
        ...
        <div className="mt-10 grid gap-4">
          ...
          <div className="grid overflow-hidden rounded-2xl border border-border bg-white md:grid-cols-[0.85fr_1.15fr] md:items-center">
            ...
            >
              <img src={howWorksSchool} alt="" className="absolute inset-0 h-full w-full object-cover opacity-30" />
            ...
            <div className="p-8 md:py-9 md:pl-2 md:pr-10">
              <h3 className="text-[22px] font-extrabold tracking-tight">Đăng lớp, để mạng lưới lấp đầy</h3>
          ...
          <div className="grid overflow-hidden rounded-2xl border border-border bg-white md:grid-cols-[1.15fr_0.85fr] md:items-center">
            <div className="order-2 p-8 md:order-1 md:py-9 md:pl-10 md:pr-2">
              <h3 className="text-[22px] font-extrabold tracking-tight">Chia sẻ link, hoa hồng tự về</h3>
              <div className="mt-5 grid gap-4">
              ...
              <a
                ...
                className="group relative mt-7 inline-flex items-center gap-3 self-start rounded-full bg-primary px-7 py-3.5 text-[14px] font-bold text-primary-foreground shadow-lift transition-all duration-300 hover:bg-primary-hover hover:shadow-glow active:scale-95"
              >
                <span>Trở thành cộng tác viên</span>
                <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
                <span
                  className="absolute inset-0 rounded-full bg-white opacity-0 transition-opacity duration-300 group-hover:opacity-10"
                  aria-hidden="true"
            ...
            >
              <img src={howWorksPartner} alt="" className="absolute inset-0 h-full w-full object-cover opacity-30" />
  ...
  return (
    <section id="team" className="py-24 md:py-28">
      <div className="mx-auto max-w-4xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-primary">Đội ngũ</p>
          <h2 className="text-[34px] font-bold leading-[1.15] tracking-tight md:text-[44px]">
            Những người xây <span className="text-gradient-brand">Affluence</span>.
          </h2>
          <p className="mt-5 text-[16px] leading-[1.75] text-ink-soft">
            Chúng tôi là đội ngũ đến từ EdTech, performance marketing và affiliate — cùng chung một niềm tin: giáo dục
            xứng đáng có công cụ tăng trưởng tử tế.
          </p>
        </div>
          ...
          {team.map((m) => (
            ...
            >
              <div className="flex items-center gap-4">
                {m.photo ? (
                  <img src={m.photo} alt={m.name} className="h-16 w-16 shrink-0 rounded-2xl object-cover shadow-lift" />
                ) : (
                  <div
...
function Values() {
  return (
    <section className="bg-white py-24 md:py-28">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          <p className="mb-3 text-[11px] font-bold uppercase tracking-[0.14em] text-primary">Giá trị cốt lõi</p>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {values.map(({ icon: Icon, title, text }) => (
            <div key={title} className="rounded-2xl border border-border bg-secondary/40 p-8 text-center">
        ...
        <div className="relative grid gap-8 md:grid-cols-[1.3fr_1fr] md:items-center">
          <div>
            ...
            <p className="mt-4 text-[15px] leading-[1.7] text-white/85 sm:text-[16px]">
              Dù bạn là trường học, trung tâm giáo dục, publisher hay mạng lưới affiliate — chúng tôi luôn sẵn sàng lắng
              nghe và kết nối để cùng phát triển.
            </p>
          </div>
